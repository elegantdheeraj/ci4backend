/*
 Theme Name: orafinance
 Theme URI: 
 Author: 
 Author URI: 
 Description: orafinance - Banking & Business Loan HTML5 Responsive Template
 Version: 1.0
 License:
 License URI:
 */
 ...
 */
 ...
 (function ($) {
    ...
    /*--------------------------------------------------------
     / 4. Customer Slider
     /---------------------------------------------------------*/
     if ($('.investors_area').length > 0) {
        $('.investors_area').owlCarousel({
            items: 2,
            margin: 0,
            autoplay: true,
            nav: true,
    ...
    /*----------------------------------------------------------------
    / Target home page to change nav color
    /----------------------------------------------------------------*/
    if (window.location.href !== $("#header .logo a").attr('href') && window.location.href !== $("#header .logo a").attr('href')+"#products") {
        $(".mainmenu ul li a").addClass("home");
    } else {
        $(".mainmenu ul li a").removeClass("home");
    }
